...
export function Booking({ availableSessionTypes, professionalName, theme }: BookingProps) {
    ...
    <section id="booking" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          <p className="preview-primary-text mb-2">Book a Session</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      {availableSessionTypes.includes('online') && (
                        <div className="relative">
                          ...
                          <Label
                            ...
                            style={{
                              borderColor: sessionType === 'online' ? theme.primaryColor : undefined,
                              backgroundColor: sessionType === 'online' ? theme.accentColor : undefined,
                            }}
                          >
                            <Video className="h-6 w-6 preview-primary-text" />
                      ...
                      {availableSessionTypes.includes('in-person') && (
                        <div className="relative">
                          ...
                          <Label
                            ...
                            className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-gray-200 bg-white p-4 hover:bg-gray-50 peer-data-[state=checked]:border-emerald-600 peer-data-[state=checked]:bg-emerald-50 cursor-pointer transition-all"
                            style={{
                              borderColor: sessionType === 'in-person' ? theme.primaryColor : undefined,
                              backgroundColor: sessionType === 'in-person' ? theme.accentColor : undefined,
                            }}
                          >
                            <MapPin className="h-6 w-6 preview-primary-text" />
                            <span>In-Person</span>
                            <span className="text-gray-500 text-center">
                              At the office
                            </span>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {timeSlots.map((time) => (
                        <button
                          ...
                          style={{
                            borderColor: selectedTime === time ? theme.primaryColor : '#e5e7eb',
                            backgroundColor: selectedTime === time ? theme.accentColor : 'white',
                            color: selectedTime === time ? theme.primaryColor : undefined,
                          }}
                        >
                          {time}
                        </button>
                ...
                <div className="space-y-4">
                  <h3 className="flex items-center gap-2 text-gray-900">
                    <User className="h-5 w-5 preview-primary-text" />
                    Your Information
                  </h3>
