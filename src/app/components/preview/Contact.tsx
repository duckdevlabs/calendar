...
export function Contact({ email, phone, whatsapp, location, theme }: ContactProps) {
  const openWhatsApp = () => {
    ...
    <section id="contact" className="py-16 md:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          <p className="preview-primary-text mb-2">Get in Touch</p>
        ...
        <div className="max-w-4xl mx-auto">
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div 
                        className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 preview-accent-bg"
                      >
                        <Icon className="h-6 w-6 preview-primary-text" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        {method.action && (
                          <Button
                            variant="link"
                            className="p-0 h-auto preview-primary-text hover:opacity-80 mt-2"
          ...
          >
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <div 
                  className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 preview-primary-bg"
                >
