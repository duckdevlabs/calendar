...
export function Footer({ professionalName }: FooterProps) {
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#booking" className="hover:text-emerald-400 transition-colors">Book Session</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="flex items-center gap-2 text-gray-400">
              Made with <Heart className="h-4 w-4 text-emerald-500" /> for better mental health
            </p>
          </div>
        </div>
      </div>
